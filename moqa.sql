...
INSERT INTO `tag` VALUES (1,'test',NULL,4),(2,'tag',NULL,9),(3,'good',NULL,5),(4,'new',NULL,6),(5,'none',NULL,2),(6,'haha',NULL,1),(7,'leetom',NULL,1),(8,'is',NULL,1),(9,'here',NULL,1),(10,'app',NULL,8),(11,'stash',NULL,11),(12,'tx',NULL,4),(13,'match',NULL,5);
...
CREATE TABLE `tagged` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='question tagged by tags.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tagged` VALUES (1,30,1),(2,30,2),(3,30,3),(4,31,4),(5,31,2),(6,31,6),(7,31,7),(8,32,4),(9,32,2),(10,32,8),(11,32,9);
...
-- Dump completed on 2014-02-28 19:40:57
